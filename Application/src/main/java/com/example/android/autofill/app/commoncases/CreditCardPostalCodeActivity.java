...
public class CreditCardPostalCodeActivity extends AppCompatActivity {
    ...
    private EditText mCcPostalCode;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.credit_card_postal_code_activity);
        ...
        mCcPostalCode = findViewById(R.id.creditCardPostalCode);
     ...
     */
    private void submit() {
        Intent intent = WelcomeActivity.getStartActivityIntent(CreditCardPostalCodeActivity.this);
